...
module.exports = (znamkyRows, prumeryRows, misc) => `<div class="container shadow-sm">
    <div class="row shadow-sm mb-3" style="color: #33528B">
        <div class="col pl-2" style="border-top: solid;">
            <h1 class="mb-0 p-1 font-weight-bold text-center float-left">Better iSAS</h1>
    ...
    <div class="row">
            ...
            🖥️ Provozní náklady této aplikace jsou financovány přímo z reklam, které vidíte. Jedná se jen o ověřené, bezpečné reklamy od Google. Každý proklik přidá pár korun, a jakmile jsou výdaje pokryty, reklamy se samy vypnou. Děkujeme, že nás podporujete! 💓 
            </div>
            </div>
        <script>
